...
-- List the manager of each department along w their
...
FROM
    department
JOIN
    dept_manager ON department.dept_no = dept_manager.dept_no
JOIN
    employees ON dept_manager.emp_no = employees.emp_no;

-- List the department number for each employee along w that
...
-- employee last name (that is, how many employees share each
-- last name).
